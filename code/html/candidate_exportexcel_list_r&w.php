...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B2', "Reading and Writing")
...
while ($line = $class_bd->retornar_fila($resultado)){
    ...
    ->setCellValue('C'.$i,$line["can_timereadingandwriting"])
...
header('Content-Disposition: attachment;filename='.$file_name.'_Reand_and_Writing.xls');
