...
$submit="Save";
$get_prc_name = $_GET["prc_name"];
$prc_id = getPrcId($get_prc_name);
?>
...
function getCandidateTypeExamYear($prc_id){
...
function write_candidateExamYear($prc_id){

	$PrepArray = getCandidateTypeExamYear($prc_id);
	$i=1;
					...
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-red-sunglo bold uppercase">Exams Per Year for <?php echo $get_prc_name;?></span>
						...
						<div class="portlet-body">
							...
							<?php 
							   //getCandidatePrepYear();
							    write_candidateExamYear($prc_id);	
							?>
							</tbody>
								</table>
							</div>
