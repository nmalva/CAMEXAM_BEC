                ...
                success : function (msg) {
                   // alert (msg);
                	...
                	if (new_can_id==-10)
                	   ...
                	   alert ("El Candidato fue agregado!. Para ser confirmado, complete los documentes y ubiquelo en estado Sent una vez finalizado en la pestaña Workflow para su verificación - !!! Por favor, revise los datos ingresados “Nombre completo, Apellido, fecha de nacimiento, DNI”, cualquier error puede incurrir en costos a cargo de la persona que realizó la carga!!!");
