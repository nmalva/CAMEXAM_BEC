...
function write_candidate($session_prc_id, $get_exa_id, $date){
    $class_bd=new bd();
    $class_utiles= new utiles();
    $folder="../../files/";
    $sql="SELECT * FROM Candidate 
                   ...
                   WHERE Exam.exa_date = '{$date}'
                   AND (Candidate.can_status= 0 OR Candidate.can_status= 3);
						...
						<div class="portlet-title">
							...
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
							<?php 
							    write_candidate($session_prc_id, $get_exa_id, $get_date);	
