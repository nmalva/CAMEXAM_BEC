...
function getCode($tabla,$connect,$op)
{
	...
	elseif ($op=='class')
	{
		//*******************************************************// 
		$buffer="<?php\n";
		$buffer.="include_once('pConnect.class.php');//configurar en este archivo la conexion a base de datos \n\n";
...
function getSet($field,$type)
{
	...
	$set.= '$sql="UPDATE tabla SET '.$field.'='.'{$value} WHERE tabla_id=tablaid";';
	$set.="\n\t".'';
