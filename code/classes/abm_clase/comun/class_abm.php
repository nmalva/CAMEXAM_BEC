 ...
 * 
		...
		adicionalInput = para agregar html dentro de los tags del input. <input type='text' {ac�}>
		...
		customPrintListado = sprintf para imprimir en el listado. %s ser� el valor del campo y {id} se remplaza por el Id del registro definido para la tabla. Ej: <a href='ver_usuario.php?id={id}' target='_blank' title='Ver usuario'>%s</a>
...
class class_abm{
	...
	public $iconoEditar="<a href=\"%s\"><img src='../classes/abm_clase/img/editar.gif' title='Editar' alt='Editar' border='0'/></a>";
	...
	/**
	 * Para saber que formulario est� mostrando (listado, alta, editar, dbDelete, dbUpdate, dbInsert), esto es util cuando queremos hacer diferentes en la pagina segun el estado.
	 *
	 */
